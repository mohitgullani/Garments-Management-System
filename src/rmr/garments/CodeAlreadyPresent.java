 ...
 * @author HP
 */
public class CodeAlreadyPresent extends javax.swing.JFrame {

    /**
     * Creates new form SelectPaymentMethod
     */
    public CodeAlreadyPresent() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("This Code is Already Present");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 170, 520, -1));
...
int xx,yy;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CodeAlreadyPresent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CodeAlreadyPresent().setVisible(true);
            }
        });
    }
