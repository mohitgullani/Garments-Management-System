 ...
 * @author HP
 */
public class SelectValidCode extends javax.swing.JFrame {

    /**
     * Creates new form SelectPaymentMethod
     */
    public SelectValidCode() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Please Select Valid Code");
...
int xx,yy;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SelectValidCode.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SelectValidCode().setVisible(true);
            }
        });
    }
