 ...
 * @author HP
 */
public class SelectValidItem extends javax.swing.JFrame {

    /**
     * Creates new form SelectPaymentMethod
     */
    public SelectValidItem() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Please Select Valid Item");
...
int xx,yy;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SelectValidItem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SelectValidItem().setVisible(true);
            }
        });
    }
