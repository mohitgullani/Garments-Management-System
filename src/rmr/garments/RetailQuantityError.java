 ...
 * @author HP
 */
public class RetailQuantityError extends javax.swing.JFrame {

    /**
     * Creates new form RetailQuantityError
     */
    public RetailQuantityError() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Quantity More Than 10 not Allowed");
...
int xx,yy;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RetailQuantityError.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RetailQuantityError().setVisible(true);
            }
        });
    }
