 ...
 * @author HP
 */
public class SelectGender extends javax.swing.JFrame {

    /**
     * Creates new form SelectGender
     */
    public SelectGender() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Please select Gender");
...
int xx,yy;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SelectGender.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SelectGender().setVisible(true);
            }
        });
    }
