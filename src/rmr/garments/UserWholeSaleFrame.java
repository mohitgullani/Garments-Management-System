 ...
 * @author HP
 */
public class UserWholeSaleFrame extends javax.swing.JFrame {

    /**
     * Creates new form HomePage
     */
    public UserWholeSaleFrame(String contact) {
        initComponents(); 
...
String str;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserWholeSaleFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                String a="";
                new UserWholeSaleFrame(a).setVisible(true);
            }
        });
    }
