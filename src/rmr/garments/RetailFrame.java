...
public class RetailFrame extends javax.swing.JFrame {
     ...
     */
    public RetailFrame(String contact) {
        initComponents(); 
...
String str;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RetailFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                String a="";
                new RetailFrame(a).setVisible(true);
            }
        });
    }
