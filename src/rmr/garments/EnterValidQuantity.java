 ...
 * @author HP
 */
public class EnterValidQuantity extends javax.swing.JFrame {

    /**
     * Creates new form SelectPaymentMethod
     */
    public EnterValidQuantity() {
        initComponents();
    }
...
int xx,yy;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EnterValidQuantity.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EnterValidQuantity().setVisible(true);
            }
        });
    }
