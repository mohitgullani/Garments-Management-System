 ...
 * @author HP
 */
public class SelectEMPID extends javax.swing.JFrame {

    /**
     * Creates new form SelectEMPID
     */
    public SelectEMPID() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Please Select Employee ID");
...
int xx,yy;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SelectEMPID.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SelectEMPID().setVisible(true);
            }
        });
    }
