 ...
 * @author HP
 */
public class SelectValidSize extends javax.swing.JFrame {

    /**
     * Creates new form SelectPaymentMethod
     */
    public SelectValidSize() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Please Select Valid Size");
...
int xx,yy;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SelectValidSize.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SelectValidSize().setVisible(true);
            }
        });
    }
