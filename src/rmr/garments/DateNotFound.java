 ...
 * @author HP
 */
public class DateNotFound extends javax.swing.JFrame {

    /** Creates new form DateNotFound */
    public DateNotFound() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Date not found");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 170, 560, -1));
...
int xx,yy;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DateNotFound.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DateNotFound().setVisible(true);
            }
        });
    }
