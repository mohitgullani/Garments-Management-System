 ...
 * @author HP
 */
public class NoEmployeeID extends javax.swing.JFrame {

    /** Creates new form NoEmployeeID */
    public NoEmployeeID(int id) {
        initComponents();
        l1.setText("There is no Employee with ID "+id);
    }
    ...
    private void initComponents() {
        ...
        l1.setFont(new java.awt.Font("Cambria Math", 0, 30)); // NOI18N
        l1.setForeground(new java.awt.Color(255, 255, 255));
        l1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        l1.setText("There is no Employee with ID");
        getContentPane().add(l1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 170, 520, -1));
...
int xx,yy;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NoEmployeeID.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                int a=0;
                new NoEmployeeID(a).setVisible(true);
            }
        });
    }
