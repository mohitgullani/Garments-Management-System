 ...
 * @author HP
 */
public class SelectDateLocation extends javax.swing.JFrame {

    /**
     * Creates new form SelectSize
     */
    public SelectDateLocation() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Please enter Date & Location");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 170, 530, -1));
...
int xx,yy;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SelectDateLocation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SelectDateLocation().setVisible(true);
            }
        });
    }
