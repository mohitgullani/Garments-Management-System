 ...
 * @author HP
 */
public class WholeSaleQuantityError extends javax.swing.JFrame {

    /**
     * Creates new form RetailQuantityError
     */
    public WholeSaleQuantityError() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Bill in Retail Window");
        ...
        jLabel3.setText("For less than 10 Quantity please create");
...
int xx,yy;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WholeSaleQuantityError.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WholeSaleQuantityError().setVisible(true);
            }
        });
    }
