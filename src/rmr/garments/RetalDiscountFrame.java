 ...
 * @author HP
 */
public class RetalDiscountFrame extends javax.swing.JFrame {

    /**
     * Creates new form DiscountFrame
     */
    public RetalDiscountFrame() {
        initComponents();
    }
    ...
    private void socksadd4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_socksadd4MouseClicked
        ...
        try
        {
            ...
            st.executeUpdate("update discount set RetailDiscount="+discount+"");
    ...
    private void formWindowGainedFocus(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowGainedFocus
        try
        {
            ...
            while(rs.next())
            {
                tf1.setText(""+rs.getInt("RetailDiscount"));
            }
        }
        catch(Exception e)
        {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RetalDiscountFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RetalDiscountFrame().setVisible(true);
            }
        });
    }
